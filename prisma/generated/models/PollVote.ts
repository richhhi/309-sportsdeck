...
export type PollVoteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"pollId" | "userId" | "pollOptionId" | "createdAt", ExtArgs["result"]["pollVote"]>
...
export interface PollVoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const pollVoteWithPollIdOnly = await prisma.pollVote.findMany({ select: { pollId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PollVotes and only return the `pollId`
   * const pollVoteWithPollIdOnly = await prisma.pollVote.createManyAndReturn({
   *   select: { pollId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PollVotes and only return the `pollId`
   * const pollVoteWithPollIdOnly = await prisma.pollVote.updateManyAndReturn({
   *   select: { pollId: true },
   *   where: {
   *     // ... provide filter here
   *   },
